...
const GridRow = () => {
  ...
  }))), /*#__PURE__*/React.createElement(View, null, /*#__PURE__*/React.createElement(Modal //visible={false}
  , {
    animationType: "slide",
    transparent: true
  }, menuVisible ? /*#__PURE__*/React.createElement(UserGridMenu, {
    onPress: callbackMenu.bind(this)
  }) : null, profileVisible ? /*#__PURE__*/React.createElement(UserProfile, {
    onPress: callbackProfile.bind(this)
  }) : null)));
};
