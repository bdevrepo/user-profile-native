...
var _reactNativeFloatingLabelInput = require("react-native-floating-label-input");
...
const User = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
  ...
  }, "Informa\xE7\xF5es pessoais"), /*#__PURE__*/_react.default.createElement(_reactNativeFloatingLabelInput.FloatingLabelInput, {
    ...
    label: item.label,
    value: item.value
  }))), /*#__PURE__*/_react.default.createElement(_reactNativeFloatingLabelInput.FloatingLabelInput, {
    label: "E-mail",
    onChangeText: text => {
      setEmailReq(text);
      props.parentUser(idetReqData);
...
_reactNativeFloatingLabelInput.setGlobalStyles.labelStyles = {
  color: 'black',
  fontSize: 14 // any styles you want to generalize to your floating label

};
_reactNativeFloatingLabelInput.setGlobalStyles.inputStyles = {
